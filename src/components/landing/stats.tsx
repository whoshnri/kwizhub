            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
                <div className="text-center space-y-6 max-w-3xl mx-auto">
                    ...
                    <h2 className={`text-3xl md:text-5xl font-bold font-heading tracking-tight leading-tight ${ibm_plex_sans.className}`}>
                        Empowering Academic <br className="hidden sm:block" />
                        Creators and Educators
                    </h2>
                    <p className="text-muted-foreground text-lg leading-relaxed">
                        The ultimate destination for verified academic creators. We provide the
                        infrastructure to publish, reach global students, and earn consistently from your expertise.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4 lg:gap-0">
                    ...
                    <div className="text-center space-y-4 lg:border-r border-border/40 py-4 px-2">
                        ...
                        <div className="text-sm text-muted-foreground font-medium uppercase tracking-wider">Expert Authors</div>
                    </div>
                </div>
            </div>
        </section>
