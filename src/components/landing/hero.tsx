...
export function Hero() {
    ...
    let ctaText = "Start Publishing Now";
    ...
    return (
        <section className="relative overflow-hidden min-h-screen flex items-center pt-20 pb-16 md:pt-48 md:pb-32 px-7">
            {/* Background Effects */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-5xl mx-auto space-y-5">
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
                        <h1 className={`text-5xl grid sm:text-5xl md:text-7xl lg:text-8xl font-bold font-heading tracking-tighter ${ibmPlexSans.className}`}>
                            <Highlight className="w-full md:w-fit mx-auto text-center">Monetise</Highlight> Your Acedemic Expertise
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
                        <Link href={ctaHref} className="w-full sm:w-auto">
                            <Button size="lg" className="w-full sm:w-auto text-base px-10 h-14 rounded-lg bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 group transition-all cursor-pointer">
                                {ctaText}
