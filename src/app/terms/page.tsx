            ...
            <main className="flex-1 py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose prose-lg max-w-none space-y-6">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold mt-8 mb-4">3. Content and Materials</h2>
                            <p className="text-muted-foreground">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold mt-8 mb-4">4. Purchases and Refunds</h2>
                            <p className="text-muted-foreground">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold mt-8 mb-4">6. Author Payments</h2>
                            <p className="text-muted-foreground">
